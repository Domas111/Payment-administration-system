...
{
$errormsg = "<div class='alert alert-success'> <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><strong>Atlikta!</strong> Gyventojo duomenys įvesti sėkmingai</div>";
}else if(isset($_REQUEST['act']) && @$_REQUEST['act']=="2")
{
$errormsg = "<div class='alert alert-success'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a> <strong>Atlikta!</strong> Gyventojo duomenys redaguoti sėkmingai</div>";
}
else if(isset($_REQUEST['act']) && @$_REQUEST['act']=="3")
{
$errormsg = "<div class='alert alert-success'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><strong>Atlikta!</strong> Gyventojo duomenys ištrinti sėkmingai</div>";
}
...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">GYVENTOJAI
						<?php
						echo (isset($_GET['action']) && @$_GET['action']=="add" || @$_GET['action']=="edit")?
						' <a href="student.php" class="btn btn-primary btn-sm pull-right">ATGAL <i class="glyphicon glyphicon-arrow-right"></i></a>':'<a href="student.php?action=add" class="btn btn-primary btn-sm pull-right"><i class="glyphicon glyphicon-plus"></i> NAUJAS GYVENTOJAS </a>';
						?>
						</h1>
     <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTbKUMvschuPNMhsxsPgiDUNbivoODLrfYEUqi0XdV62yv-FVv3Iw" alt="Cheetah!" class="paveikslas2" />                
<?php
			...
			<script type="text/javascript" src="js/validation/jquery.validate.min.js"></script>
               ...
               <div class="panel panel-primary">
                        <div class="panel-heading">
                           <?php echo ($action=="add")? "Įrašyti naują gyventoją": "Informacija/Redaguoti"; ?>
                        </div>
						<form action="student.php" method="post" id="signupForm1" class="form-horizontal">
                        <div class="panel-body">
						<fieldset class="scheduler-border" >
						 <legend  class="scheduler-border">Informacija apie gyventoją:</legend>
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">Vardas/Pavardė* </label>
								<div class="col-sm-10">
									<input type="text" class="form-control" id="sname" name="sname" value="<?php echo $sname;?>"  />
								</div>
							</div>
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">Tel.numeris* </label>
								<div class="col-sm-10">
						...
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">Mokėjimo paskirtis* </label>
								<div class="col-sm-10">
						...
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">Prisijungimo data* </label>
								<div class="col-sm-10">
							...
							<fieldset class="scheduler-border" >
						 <legend  class="scheduler-border">Apmokėjimo informacija:</legend>
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">Mokėjimo suma&nbsp;&euro; </label>
								<div class="col-sm-10">
						...
						?>
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">Pirma įmoka&nbsp;&euro; </label>
								<div class="col-sm-10">
						...
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">Liko apmokėti&nbsp;&euro;</label>
								<div class="col-sm-10">
						...
						?>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="Password">Pastabos </label>
								<div class="col-sm-10">
						...
						?>
							 ...
							 <fieldset class="scheduler-border" >
						 <legend  class="scheduler-border">Kontaktiniai duomenys:</legend>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="Password">Adresas </label>
								<div class="col-sm-10">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">El.Paštas </label>
								<div class="col-sm-10">
		 ...
		 ?>
			...
			?>
				...
				errorPlacement: function ( error, element ) {
					// Į klaidos elementą prideda „pagalbos bloko“ klasę
					error.addClass( "help-block" );

					// Įtraukta „has-feedback“ klasė į pagrindinę div.form grupę
					// kad įsivestų piktogramos
					...
					// Prideda span elementą, jei neegzistuoja, ir pritaikykomos piktogramų klasės.
                            ...
                            <div class="table-sorting table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="tSortable22">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Vardas/Tel.numeris</th>
                                            <th>Prisijungimo data</th>
                                            <th>Mokėjimo suma&nbsp;&euro;</th>
											<th>Liko apmokėti&nbsp;&euro;</th>
											<th>Informacija/redaguoti</th>
                                        </tr>
                                    </thead>
                                    <tbody>
									<?php
									...
									echo '<tr '.(($r['balance']>0)?'class="danger"':'').'>
											...
											<a onclick="return confirm(\'Ar tikrai norite ištrinti šį įrašą?\');" href="student.php?action=delete&id='.$r['id'].'" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span></a> </td>
