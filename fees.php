...
{
$errormsg = "<div class='alert alert-success'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><strong>Atlikta!</strong> Mokėjimas įvykdytas </div>";
}
...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">MOKĖJIMAI 
...
<fieldset class="scheduler-border" >
    <legend  class="scheduler-border">Paieška:</legend>
<form class="form-inline" role="form" id="searchform">
  <div class="form-group">
   ...
   <div class="form-group">
    <label for="email"> Prisijungimo data </label>
    <input type="text" class="form-control" id="doj" name="doj" >
  </div>
  
  <div class="form-group">
    <label for="email"> Mokėjimo paskirtis </label>
   ...
   <button type="button" class="btn btn-success btn-sm" id="find" > Rasti </button>
  <button type="reset" class="btn btn-danger btn-sm" id="clear" > Trinti </button>
</form>
</fieldset>
...
function mydatatable()
{
              ...
              $("#subjectresult").html('<table class="table table-striped table-bordered table-hover" id="tSortable22"><thead><tr><th>Vardas/Tel.numeris</th><th>Mokėjimo suma&nbsp;&euro;</th><th>Liko apmokėti&nbsp;&euro;</th><th>Mokėjimo paskirtis</th><th>Prisijungimo data</th><th>Mokėjimas</th></tr></thead><tbody></tbody></table>');
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Priimti mokėjimą</h4>
        </div>
