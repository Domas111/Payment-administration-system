...
test( "defaultMessage(), empty title is ignored", function() {
	...
	equal( v.defaultMessage( $( "#username" )[ 0 ], { method: "required", parameters: true } ), "Būtina užpildyti lauką." );
} );
...
test( "works on contenteditable fields", function( assert ) {
	...
	assert.hasError( $( "#contenteditableRequiredInvalid" ), "Būtina užpildyti lauką." );
