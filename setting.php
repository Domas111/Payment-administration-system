...
$error = '<div class="alert alert-danger">
  ...
  <strong>Error!</strong> Neteisingai įvestas senas slaptažodis
</div>';
}
...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">NUSTATYMAI</h1>
...
echo '<div class="alert alert-success">
  <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
  <strong>Atlikta!</strong> Slapttažodis pakeistas sėkmingai.
</div>';
...
?>
               ...
               <div class="panel panel-primary">
						...
						<div class="form-group">
								<label class="col-sm-4 control-label" for="Old">Esamas slaptažodis</label>
								<div class="col-sm-5">
							...
							<div class="form-group">
								<label class="col-sm-4 control-label" for="Password"> Naujas slaptažodis</label>
								<div class="col-sm-5">
							...
							<div class="form-group">
								<label class="col-sm-4 control-label" for="Confirm">Pakartoti slaptažodį</label>
								<div class="col-sm-5">
    ...
    <script src="js/custom1.js"></script>
		...
		$( document ).ready( function () {			
			...
			$( "#signupForm1" ).validate( {
				...
				messages: {
					oldpassword: "Įveskite seną slaptažodį",
					
					newpassword: {
						required: "Įveskite naują slaptažodį",
						minlength: "Slatažodį turi sudaryti 6 mažiausiai simboliai"
					},
					confirmpassword: {
